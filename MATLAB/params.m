...
% Convert desired -3 dB bandwidth to equivalent 2nd-order natural frequency
r_bw = sqrt(1 - 2*zeta^2 + sqrt(2 - 4*zeta^2 + 4*zeta^4));
wn = 2*pi*bw / r_bw;

% Third pole imposed by the differentiator dynamics
p3 = b + wf - 2*zeta*wn;
